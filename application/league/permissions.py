...
ROLES={'admin':'子赛事管理员'}
ACTIONS={'team','player','team-update','player-update','stage','stage-update','rule','match','lineup','score','publish','correct','cancel','visibility','settlement-preview','settlement-commit','archive-preview','archive-commit'}
